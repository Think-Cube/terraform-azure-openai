# Example: Advanced — Azure Openai

Provisions an Azure OpenAI Service account with cognitive deployment support. Full-featured example with optional configuration blocks enabled.
